...
<!--				<li><a href="blog.html">News</a></li>-->
    ...
    <div class="id1">
        <ul class="id2">
				<li class="id3"><a href="services.php" class="id8">Hair</a></li>
    ...
    try{
                    ...
                    $sqlquery1="SELECT * FROM service WHERE s_name LIKE '%hair%'";
        ...
        <span style="width:50%;">
            <img src="img/blog/1.jpg" alt="image" style="width:750px;height:250px;">
            <div>
                
                <h2 style="color:rgb(255, 0, 102);">Hair services</h2>
