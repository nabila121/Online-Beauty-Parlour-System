...
<!--				<li><a href="blog.html">News</a></li>-->
    ...
    <div class="id1">
        <ul class="id2">
				...
				<li class="id3"><a href="nail.php" class="id8">Nail</a></li>
    ...
    try{
                    ...
                    $sqlquery1="SELECT * FROM service WHERE s_name='nail'";
        ...
        <span style="width:50%;">
            <img src="img/blog/3.jpg" alt="image" style="width:750px;height:250px;">
            <div>
                
                <h2 style="color:rgb(255, 0, 102);padding-left:755px;">Nail services</h2>
                <p style="padding-left:755px;">At the Beauty Parlour, we believe in beauty with a conscience. We have created a salon that offers the highest quality nail services in a setting that is healthier for the environment, our guests and our staff. The Beauty Parlour is designed and built primarily with recycled materials: the floor is made of reclaimed wood from a local grain elevator – preserving and showcasing its natural texture – and most of the fixtures and furniture are refurbished or original vintage pieces.

We carry high quality professional nail products designed to ensure our guests look their best, both in the salon and at home. The nail care products we carry have been carefully chosen based both on performance and eco-sensitivity. As a clean air salon, we offer ammonia-free colour services with little to no scent properties or chemical emanation. This healthier alternative to traditional colouring practices is also safe for expectant mothers and individuals with allergies or scent sensitivities.

Our design and philosophy work hand in hand. We are committed to providing healthy nail care with a low impact on the environment. Come see what you and your nail can do for the Earth.
                </p>
            </div>
        </span>
    </div>
